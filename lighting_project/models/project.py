...
class LightingProject(models.Model):
    ...
    country_id = fields.Many2one(
        comodel_name="res.country", ondelete="restrict", string="Country", required=True
    )
    ...
    description = fields.Text(
        string="Description", translate=True, track_visibility="onchange"
    )
