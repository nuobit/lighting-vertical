...
class LightingProduct(models.Model):
    ...
    website_published = fields.Boolean(
        "Published on Website", copy=False, track_visibility="onchange"
    )
    ...
    meta_title_length = fields.Integer(
        string="Meta title length", compute="_compute_lengths", readonly=True
    )
    meta_description_length = fields.Integer(
        string="Meta description length", compute="_compute_lengths", readonly=True
    )
    ...
    marketplace_title = fields.Char(
        string="Marketplace Title", translate=True, track_visibility="onchange"
    )
    marketplace_description = fields.Text(
        string="Marketplace Description", translate=True, track_visibility="onchange"
    )
