...
SPECIAL_SPECTRUM_MAP = {
    'meat': 'Meat', 'fashion': 'Fashion', 'multifood': 'Multi Food',
    'bread': 'Bread', 'fish': 'Fish', 'vegetable': 'Vegetable',
    'blue': 'Blue', 'orange': 'Orange', 'green': 'Green', 'red': 'Red',
    'purple': 'Purple', 'pink': 'Pink', 'sunlike': 'Sunlike',
    'dtw': 'DtW', 'tw': 'TW',
}
...
def migrate(env, version):
    ...
    for (code,) in records:
        special_spectrum = (
            env['lighting.product.special.spectrum'].with_context(lang='en_US').create({
