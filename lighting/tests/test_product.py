...
class TestProduct(common.TransactionCase):
        ...
        tests = [
            {
                "arrange": {
                    "state_marketing": "ES",
                    "available_qty": 0,
                    "stock_future_qty": MIN_QTY,
                },
                "actassert": lambda x: assert_validationerror(
                    x.write, {"state_marketing": "D"}
                ),
            },
            {
                "arrange": {
                    "state_marketing": "ES",
                    "available_qty": MIN_QTY,
                    "stock_future_qty": 0,
                },
                "actassert": lambda x: assert_validationerror(
                    x.write, {"state_marketing": "D"}
            ...
            },
            {
                "act": lambda x: x.write(
                    {"state_marketing": "D", "available_qty": 0, "stock_future_qty": 0}
                ),
                "assert": lambda x: self.assertEqual(
                    x.state_marketing,
                    "D",
            ...
            {
                "act": lambda x: x.write(
                    {"state_marketing": "H", "available_qty": 0, "stock_future_qty": 0}
                ),
                "assert": lambda x: self.assertEqual(
                    x.state_marketing,
                    "H",
            ...
            {
                "act": lambda x: x.write(
                    {"state_marketing": "C", "available_qty": 0, "stock_future_qty": 0}
                ),
                "assert": lambda x: self.assertEqual(
                    x.state_marketing,
                    "C",
            ...
            },
            {
                ...
                "act": lambda x: x.write(
                    {"available_qty": MIN_QTY - 1, "stock_future_qty": MIN_QTY - 1}
                ),
                "assert": lambda x: self.assertEqual(
                    x.state_marketing,
                    "ESH",
    ...
    def test_color_temperature_flux_000_to_011(self):
        ...
        p1.source_ids.line_ids.color_temperature_flux_ids = [
            (
                0,
                0,
                {
        ...
        self.assertTupleEqual(
            (
                p1.source_ids.line_ids.color_temperature_flux_ids.color_temperature_id.value,
